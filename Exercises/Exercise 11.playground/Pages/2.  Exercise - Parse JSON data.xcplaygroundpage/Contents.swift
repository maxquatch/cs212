...
/*:
 3.  Using either the iTunes music query URL you generated in page 1 of this exercise, or the one provided below, query the iTunes server for your favorite song.  This time, instead of just printing out the returned data as a String, use a JSONDecoder to parse the returned data into a Results object.  Then, print out the artist and track name to the debug area.
 */
