...
## 1. Optional String (if statement)
 ...
 Make sure to try out your code for different values of password -- any time you add or remove code, the Playground should execute again and set password to a new value.  Alternately, you can also do Editor -> Execute Playground to get a new password, or hit the play button towards the bottom of this window.
*/
